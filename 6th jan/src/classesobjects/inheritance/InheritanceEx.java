...
public class InheritanceEx {
    public static void main(String[] args) {
        ...
        Employee ex = new Employee(1,"Ram",5000);
        /*
        ex.displayEmp();
       ...
       */
       ...
       // Manager is-a Employee, so Manager object can be assigned Employee reference
        Employee e2 = new Manager(5,"Rahul",65000,
                10,"HR",10000);
        ...
        meth(new Manager(3,"Naina",80000,4,
                "Accounts",10000));
        */
        Manager m2 = new Manager(4,"Nisha",90000,4,
                "Project",10000);
        meth1(m2);

        meth1(new WageEmployee(9,"Meeta",4000,200,20));
